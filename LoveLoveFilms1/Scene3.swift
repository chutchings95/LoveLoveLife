...
class Scene3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let imageData = NSData(contentsOfURL: NSBundle.mainBundle().URLForResource("grad-dog", withExtension: "gif")!)
        let imageGif = UIImage.gifWithData(imageData!)
        let imageView = UIImageView(image: imageGif)
        imageView.frame = CGRect(x: 50.0, y: 550.0, width: 210.0, height: 180.0)
